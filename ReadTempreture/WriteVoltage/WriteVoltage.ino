...
//#define USE_ETHERNET_SHIELD
  ...
  #error "Uncomment the #define for either USE_WIFI101_SHIELD or USE_ETHERNET_SHIELD"
    ...
    // Use WiFi
      ...
      #include <WiFi101.h>
    #endif
    char ssid[] = "MohammadHadi";    //  your network SSID (name) 
...
/*
  ...
  *****************************************************************************************/
unsigned long myChannelNumber = 496626;
const char * myWriteAPIKey = "966AS0R2GGBMUUKT";
...
//  int sensorValue = analogRead(A0);
 ...
 float incomingValue = atof(buffer);
 Serial.println(incomingValue);
  ...
  //float temp = voltage* 5.0 * 100;
  // Write to ThingSpeak. There are up to 8 fields in a channel, allowing you to store up to 8 different
  // pieces of information in a channel.  Here, we write to field 1.
  ThingSpeak.writeField(myChannelNumber, 1, incomingValue, myWriteAPIKey);
